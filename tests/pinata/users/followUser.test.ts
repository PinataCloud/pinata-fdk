...
import { followUser } from "../../../src/core/pinata/users/followUser";
...
describe('followUser function', () => {
  ...
  it('should follow a user', async () => {
    ...
    const result = await followUser(mockRequest, mockConfig);
  ...
  it('should throw error if fetch fails', async () => {
    ...
    await expect(followUser(mockRequest, mockConfig)).rejects.toThrow(mockError);
  });
});